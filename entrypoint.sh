...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'5bd9bf24-199b-4be6-b538-363b6319cd9e'}
...
ARGO_AUTH='{"AccountTag":"5fdb4c6727d9b75a682d8481272a0471","TunnelSecret":"bN1aPmC5pUnuOG+FrzokEpvc3AKqW4wpiWq4Uf+SH5s=","TunnelID":"0d766685-41e1-4a6a-ab57-423f7ba29e26"}'
ARGO_DOMAIN=iojygh.ieuue673hvgch0fc8hgvghvhsd.ml
